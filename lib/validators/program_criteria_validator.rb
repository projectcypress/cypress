  ...
  class ProgramCriteriaValidator < QrdaFileValidator
    ...
    def validate_criteria(checked_criteria)
      xpath_map = {
        ...
        'MIPS APP APM Entity Identifier' => "//cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization/cda:id[@extension='#{checked_criteria.entered_value}' and @root='2.16.840.1.113883.3.249.5.4']",
