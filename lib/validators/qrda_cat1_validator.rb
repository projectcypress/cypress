...
module Validators
  class QrdaCat1Validator < QrdaFileValidator
    ...
    def initialize(bundle, measures = [])
      @measures = measures
      @validators = [CDA.instance, Cat1R2.instance, HealthDataStandards::Validate::DataValidator.new(bundle, measures.collect(&:hqmf_id))]
    end
    ...
    def validate(file, options = {})
      ...
      @measures.each do |measure|
        ...
        measure_xpath = %(//cda:organizer[./cda:templateId[@root='2.16.840.1.113883.10.20.24.3.98']]/cda:reference[@typeCode='REFR']/
