module Validators
  ...
  class CalculatingAugmentedResults
    def self.augmented_sup_val_expected?(task, keys_and_ids, code, expect_report)
      ...
      task.augmented_patients.each do |rec_changes|
        ...
        next unless augmented_record_in_population?(task, rec_changes, keys_and_ids) &&
