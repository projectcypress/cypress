...
module Cypress
  ...
  class QRDAExporter
    ...
    def export(patient)
      ...
      options = { provider: patient.providers.first, patient_addresses: patient.addresses, patient_telecoms: patient.telecoms, submission_program: cat1_submission_program, start_time: start_time, end_time: end_time }
