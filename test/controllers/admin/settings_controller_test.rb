  ...
  test 'should successfully update yml' do
    ...
    begin
      for_each_logged_in_user([ADMIN]) do
        patch :update, banner_message: 'banner test', warning_message: 'banner warning test', mailer_address: 'smtp.example.com', mailer_port: 3000, mailer_domain: 'example.com',
      ...
      assert_equal 'banner warning test', Cypress::AppConfig['warning_message']
