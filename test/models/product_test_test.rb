...
class ProductTestTest < ActiveJob::TestCase
  ...
  def test_repeatability_with_random_seed
    ...
    test1 = @product.product_tests.build({ :name => 'mtest', :measure_ids => ['8A4D92B2-397A-48D2-0139-C648B33D5582'],
                                           :bundle_id => '4fdb62e01d41c820f6000001', :rand_seed => seed }, MeasureTest)
    test2 = @product.product_tests.build({ :name => 'mtest', :measure_ids => ['8A4D92B2-397A-48D2-0139-C648B33D5582'],
                                           :bundle_id => '4fdb62e01d41c820f6000001', :rand_seed => seed }, MeasureTest)
