...
class ExpectedResultsValidatorTest < ActiveSupport::TestCase
  ...
  def setup_augmented_patients
    ...
    CompiledResult.create(IPP: true, patient_id: @patient1.id, patient: @patient1, measure: @measure)
    ...
    CompiledResult.create(IPP: true, patient_id: @patient2.id, patient: @patient2, measure: @measure)
    ...
    CompiledResult.create(IPP: true, patient_id: @patient3.id, patient: @patient3, measure: @measure)
