...
class ExpectedResultsValidatorTest < ActiveSupport::TestCase
  ...
  def setup_augmented_patients
    ...
    QDM::IndividualResult.create(IPP: 1, cqm_patient: @patient1, patient_id: @patient1.id, patient: @patient1, measure: @measure)
    ...
    QDM::IndividualResult.create(IPP: 1, cqm_patient: @patient2, patient_id: @patient2.id, patient: @patient2, measure: @measure)
    ...
    QDM::IndividualResult.create(IPP: 1, cqm_patient: @patient3, patient_id: @patient3.id, patient: @patient3, measure: @measure)
