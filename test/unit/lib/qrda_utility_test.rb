...
class QRDATest < ActiveSupport::TestCase
  ...
  test "Should get specific results" do
    ...
    expected1 = {:population=>1000, :denominator=>500, :numerator=>400, :population_ids=>{ :IPP=>"D77106C4-8ED0-4C5D-B29E-13DBF255B9FF", :DENOM=>"8B0FA80F-8FFE-494C-958A-191C1BB36DBF", :NUMER=>"9363135E-A816-451F-8022-96CDA7E540DD"}}
    ...
    expected2 = {:population=>1000, :denominator=>500, :numerator=>400, :population_ids=>{ :IPP=>"D77106C4-8ED0-4C5D-B29E-13DBF255B9FF", :DENOM=>"8B0FA80F-8FFE-494C-958A-191C1BB36DBF", :NUMER=>"9363135E-A816-451F-8022-96CDA7E540TT"}}
    # key3 = key1 + key2
