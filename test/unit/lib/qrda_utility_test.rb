...
class QRDATest < ActiveSupport::TestCase
  ...
  test "Should get specific results" do
    key1 = [{:measure_id=>"8a4d92b2-36af-5758-0136-ea8c43244986", :set_id=>"03876d69-085b-415c-ae9d-9924171040c2", :ipp=>"D77106C4-8ED0-4C5D-B29E-13DBF255B9FF", :den=>"8B0FA80F-8FFE-494C-958A-191C1BB36DBF", :num=>"9363135E-A816-451F-8022-96CDA7E540DD"}]
    expected1 = {{:measure_id=>"8a4d92b2-36af-5758-0136-ea8c43244986", :set_id=>"03876d69-085b-415c-ae9d-9924171040c2", :ipp=>"D77106C4-8ED0-4C5D-B29E-13DBF255B9FF", :den=>"8B0FA80F-8FFE-494C-958A-191C1BB36DBF", :num=>"9363135E-A816-451F-8022-96CDA7E540DD"}=>{:ipp=>1000, :den=>500, :num=>400, :denex=>20}}
    key2 = [{:measure_id=>"8a4d92b2-37d1-f95b-0137-dd4b0eb62de6", :set_id=>"3fd13096-2c8f-40b5-9297-b714e8de9133", :msr_popl=>"1A09812C-D22A-4584-B8A7-DB6D1316D75A", :strata=>"5BB34B00-FF71-404F-B301-978D71BD4580"}]
    expected2 = {{:measure_id=>"8a4d92b2-37d1-f95b-0137-dd4b0eb62de6", :set_id=>"3fd13096-2c8f-40b5-9297-b714e8de9133", :msr_popl=>"1A09812C-D22A-4584-B8A7-DB6D1316D75A", :strata=>"5BB34B00-FF71-404F-B301-978D71BD4580", :MEDIAN=>"ecd9156f-370b-40d9-86b6-5c00f0ff9629"}=>{:msr_popl=>500, :strata=>50, :MEDIAN=>55}}
    key3 = key1 + key2
    ...
    assert_equal expected1, Cypress::QrdaUtility.extract_results_by_ids(@doc, key1)
    assert_equal expected2, Cypress::QrdaUtility.extract_results_by_ids(@doc, key2)
