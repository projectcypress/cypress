...
class TestExecutionTest < ActiveSupport::TestCase
  ...
  test "Should know if it passed or failed" do
    assert !@execution_failed.passing?, "Failing execution reporting it passed"
    assert @execution_passed.passing?, "Passing execution reporting it failed"
  end
...
=begin
  ...
  test "Should report correct success rate" do
    puts @execution_failed.success_rate
    puts @execution_passed.success_rate
    puts @execution_half_passed.success_rate 
