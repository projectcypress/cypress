FactoryBot.define do
  factory :provider, class: Provider do
    ...
    trait :default do
      identifiers do
        [{ 'namingSystem' => '2.16.840.1.113883.4.6', 'value' => '020700270' },
    ...
    trait :tin do
      identifiers do
        [{ 'namingSystem' => '2.16.840.1.113883.4.6', 'value' => '1520670765' },
    ...
    trait :npi do
      identifiers do
        [{ 'namingSystem' => '2.16.840.1.113883.4.6', 'value' => '1480614951' },
