FactoryBot.define do
  factory :measure, class: Measure do
    ...
    sequence(:name) { |i| "Measure Name #{seq_id}" }
    sequence(:hqmf_id) { |i| "53e3f13d-e5cf-445f-8dda-3720aff8401#{seq_id}" }
    sequence(:hqmf_set_id) { |i| "7c00e09b-02dc-458b-8587-7f0347a443f#{seq_id}" }
