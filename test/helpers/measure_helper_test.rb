...
class MeasureHelperTest < ActiveSupport::TestCase
  def setup
    APP_CONSTANTS['CPC_measures'] = { '2018' => %w[53e3f13d-e5cf-445f-8dda-3720aff84011 53e3f13d-e5cf-445f-8dda-3720aff84012] }
    @bundle = FactoryBot.create(:static_bundle)
    @cpc_and_diag_msrs = ['53e3f13d-e5cf-445f-8dda-3720aff84011']
    @cpc_msrs = ['53e3f13d-e5cf-445f-8dda-3720aff84012']
    @diag_msrs = ['53e3f13d-e5cf-445f-8dda-3720aff84010']
    @other_measures = %w[53e3f13d-e5cf-445f-8dda-3720aff84014 53e3f13d-e5cf-445f-8dda-3720aff84015]
  end
  ...
  def product_test_with_test_execution_with_state(state)
    ...
    task.test_executions.build(state:)
    test
  end
end
