...
APP_CONSTANTS = YAML.safe_load_file(File.expand_path('cypress.yml', __dir__), aliases: true)
NAMES_RANDOM = YAML.safe_load_file(File.expand_path('names.yml', __dir__), aliases: true)
TEST_ATTRIBUTES = YAML.safe_load_file(File.expand_path('testing_attributes.yml', __dir__), aliases: true)
