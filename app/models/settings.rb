...
class Settings
  ...
  field :default_bundle, type: String, default: '2020.0.0'
  ...
  field :vendor_file_path, type: String, default: 'temp/vendor_patients'
  ...
  def self.locals_edit(application_mode_settings)
    {
      ...
      downloadable_bundles: current.downloadable_bundles, downloadable_bundles_path: current.downloadable_bundles_path
    }
  end
