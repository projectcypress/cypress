class ProductTest
  ...
  private
  def self.check_for_reported_results_population_ids(expected_result, reported_result, logger)
    _ids = expected_result["population_ids"].dup
  ...
  private
  def self.check_population(expected_result, reported_result, pop_key, stratification, logger)
  ...
  private
  def self.check_supplemental_data(expected_supplemental_value, reported_supplemantal_value,
