...
class VendorsController < ApplicationController
  ...
  def create
    ...
    bring_your_own_data = File.path(params[:vendor][:byod].tempfile) unless !params[:vendor][:byod]
    ...
    # If the user brought their own data, kick off a resque job to import it
    if bring_your_own_data
      # This should happen as a resque job
      # Cypress::PatientImportJob.create('zip_file_location' => bring_your_own_data, 'test_id' => vendor._id)
      Zip::ZipFile.foreach(bring_your_own_data) do |zip_entry|
