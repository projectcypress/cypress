require 'version'
pdf.image "#{Rails.root}/app/assets/images/cypress_logo.png", :height =>20, :width => 100
pdf.text_box "Test Results Produced by Project Cypress #{Cypress::Version.current} - projectcypress.org", :at =>[105, 715]
stroke_color 'AAAAAA'
...
{:text => "#{modules.slice(0, modules.index(':')+1)}", :color => '666666', :size => 10},{ :text =>" #{modules.slice(modules.index(':') + 2, modules.length)}"},],:at=> [10, 515]
