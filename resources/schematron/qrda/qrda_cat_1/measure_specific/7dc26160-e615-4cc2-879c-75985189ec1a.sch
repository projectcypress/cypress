...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://purl.oclc.org/dsdl/schematron C:/Users/rickg/workspaces-svn/ClientProjects/QRDATesting/measure-specific-schematron/schematron.xsd">
	...
	<pattern id="p">
		<rule context="/cda:ClinicalDocument">
			...
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.63'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.117.1.7.1.221']">For QDT pattern 'Procedure, Order: Rehabilitation Services', QRDA template id "2.16.840.1.113883.10.20.24.3.63" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.117.1.7.1.221". </assert>
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.82'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.117.1.7.1.306']">For QDT pattern 'Transfer To: Rehabilitation Facility', QRDA template id "2.16.840.1.113883.10.20.24.3.82" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.117.1.7.1.306". </assert>
