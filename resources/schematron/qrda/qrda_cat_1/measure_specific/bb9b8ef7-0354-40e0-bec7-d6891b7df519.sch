...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://purl.oclc.org/dsdl/schematron C:/Users/rickg/workspaces-svn/ClientProjects/QRDATesting/measure-specific-schematron/schematron.xsd">
	...
	<pattern id="p">
		<rule context="/cda:ClinicalDocument">
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.11'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.464.0003.08.02.0011']">For QDT pattern 'Diagnosis, Active: All Cancer', QRDA template id "2.16.840.1.113883.10.20.24.3.11" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.464.0003.08.02.0011". </assert>
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.11'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.526.03.376']">For QDT pattern 'Diagnosis, Active: Heart Failure', QRDA template id "2.16.840.1.113883.10.20.24.3.11" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.526.03.376". </assert>
			...
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.28'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.464.0003.18.02.0031']">For QDT pattern 'Functional Status, Result: Functional Status Assessment for Heart Failure', QRDA template id "2.16.840.1.113883.10.20.24.3.28" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.464.0003.18.02.0031". </assert>
