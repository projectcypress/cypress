...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://purl.oclc.org/dsdl/schematron C:/Users/rickg/workspaces-svn/ClientProjects/QRDATesting/measure-specific-schematron/schematron.xsd">
	...
	<pattern id="p">
		<rule context="/cda:ClinicalDocument">
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.11'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.464.1003.113.12.1037']">For QDT pattern 'Diagnosis, Active: Fracture - Lower Body', QRDA template id "2.16.840.1.113883.10.20.24.3.11" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.464.1003.113.12.1037". </assert>
			...
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.28'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.464.1003.118.12.1030']">For QDT pattern 'Functional Status, Result: Functional Status Assessment for Knee Replacement', QRDA template id "2.16.840.1.113883.10.20.24.3.28" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.464.1003.118.12.1030". </assert>
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.64'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.464.1003.198.12.1007']">For QDT pattern 'Procedure, Performed: Primary TKA Procedure', QRDA template id "2.16.840.1.113883.10.20.24.3.64" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.464.1003.198.12.1007". </assert>
