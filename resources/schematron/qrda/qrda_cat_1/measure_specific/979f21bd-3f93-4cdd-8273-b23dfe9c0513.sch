...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://purl.oclc.org/dsdl/schematron C:/Users/rickg/workspaces-svn/ClientProjects/QRDATesting/measure-specific-schematron/schematron.xsd">
	...
	<pattern id="p">
		<rule context="/cda:ClinicalDocument">
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.11'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.117.1.7.1.299']">For QDT pattern 'Diagnosis, Active: Psychiatric/Mental Health Patient', QRDA template id "2.16.840.1.113883.10.20.24.3.11" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.117.1.7.1.299". </assert>
			<assert test="//*[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.22'][descendant::*/@sdtc:valueSet='2.16.840.1.113883.3.117.1.7.1.295']">For QDT pattern 'Encounter, Order: Decision to Admit to Hospital Inpatient', QRDA template id "2.16.840.1.113883.10.20.24.3.22" SHOULD be present and SHOULD be bound to value set "2.16.840.1.113883.3.117.1.7.1.295". </assert>
