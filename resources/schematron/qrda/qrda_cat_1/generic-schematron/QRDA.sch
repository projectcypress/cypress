...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:cda="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.49-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.49-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-8712" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.22.4.49'][@root='2.16.840.1.113883.10.20.22.4.49'])=1">SHALL contain exactly one [1..1] templateId (CONF:8712) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.22.4.49" (CONF:26353). SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.22.4.49" (CONF:10494).</sch:assert>
...
SHALL contain exactly one [1..1] effectiveTime (CONF:14445).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.55-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.55-errors-abstract" abstract="true">
      <sch:assert id="a-12561" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.24.3.55'])=1">SHALL contain exactly one [1..1] templateId (CONF:12561) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.24.3.55" (CONF:12562).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.98-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.98-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-12985-c" test="cda:reference[@typeCode='REFR']/cda:externalDocument[@classCode='DOC']/cda:id[@root]">This externalDocument SHALL contain exactly one [1..1] id (CONF:12985).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.97-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.97-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-12811-c" test="cda:reference[@typeCode='REFR']/cda:externalDocument[@classCode='DOC']/cda:id[@root]">This externalDocument SHALL contain exactly one [1..1] id (CONF:12811).</sch:assert>
      <sch:assert id="a-12812-c" test="not(tested-here)">This id SHALL contain exactly one [1..1] @root (CONF:12812).</sch:assert>
      <sch:assert id="a-12813-c" test="not(testable)">This ID SHALL equal the version specific identifier for eMeasure (i.e. QualityMeasureDocument/id) (CONF:12813).</sch:assert>
    </sch:rule>
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.97-12808-branch-12808-errors-abstract" abstract="true">
      <sch:assert id="a-12810-branch-12808" test="count(cda:externalDocument[@classCode='DOC'])=1">SHALL contain exactly one [1..1] externalDocument="DOC" Document (CodeSystem: HL7ActClass 2.16.840.1.113883.5.6 STATIC) (CONF:12810).</sch:assert>
    </sch:rule>
...
SHALL contain exactly one [1..1] custodian (CONF:16600).</sch:assert>
      ...
      <sch:assert id="a-16857" test="cda:recordTarget/cda:patientRole[count(cda:id)=1]">This patientRole SHALL contain exactly one [1..1] id (CONF:16857) such that it</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.14-warnings">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.14-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-7683" test="not(cda:targetSiteCode) or count(cda:targetSiteCode) &gt; 0">SHOULD contain zero or more [0..*] targetSiteCode (CONF:7683).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.87-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.87-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.22.4.2-warnings-abstract" />
      <sch:assert id="a-16702-c" test="count(cda:value[@xsi-type='PQ'])=0 or count(cda:value[@xsi-type='PQ'])=1">If xsi:type=PQ, then @units shall be drawn from Unified Code for Units of Measure (UCUM) 2.16.840.1.113883.6.8 code system. Additional constraint is dependent on criteria in the corresponding eMeasure (CONF:16702).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.91-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.91-warnings-abstract" abstract="true">
      <sch:assert id="a-13286" test="count(cda:effectiveTime)&lt;=1">SHOULD contain zero or one [0..1] effectiveTime (CONF:13286).</sch:assert>
      <sch:assert id="a-13287" test="count(cda:value)&lt;=1">SHOULD contain zero or one [0..1] value (CONF:13287).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.40-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.40-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.22.4.2-warnings-abstract" />
      <sch:assert id="a-16698-c" test="count(cda:value[@xsi-type='PQ'])=0 or count(cda:value[@xsi-type='PQ'])=1">If xsi:type=PQ, then @units shall be drawn from Unified Code for Units of Measure (UCUM) 2.16.840.1.113883.6.8 code system. Additional constraint is dependent on criteria in the corresponding eMeasure (CONF:16698).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.16-warnings">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.16-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-7513-c" test=" not(cda:effectiveTime) or  count(cda:effectiveTime[@operator='A'][@xsi:type='PIVL_TS' or @xsi:type='EIVL_TS']) &lt;=1">SHOULD contain zero or one [0..1] effectiveTime (CONF:7513) such that it SHALL contain exactly one [1..1] @operator="A" (CONF:9106).</sch:assert>
      ...
      <sch:assert id="a-9105-c" test="not(tested-here)">SHALL contain exactly one [1..1] @xsi:type=?PIVL_TS? or ?EIVL_TS? (CONF:9105).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.47-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.47-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.22.4.42-warnings-abstract" />
      <sch:assert id="a-12602" test="count(cda:doseQuantity) &lt; 2">SHOULD contain zero or one [0..1] doseQuantity (CONF:12602).</sch:assert>
      <sch:assert id="a-12603" test="not(cda:doseQuantity) or cda:doseQuantity[@unit]">The doseQuantity, if present, SHOULD contain zero or one [0..1] @unit, which SHALL be selected from ValueSet UnitsOfMeasureCaseSensitive 2.16.840.1.113883.1.11.12839 DYNAMIC (CONF:12603).</sch:assert>
      <sch:assert id="a-12607-c" test="not(cda:rateQuantity) or cda:rateQuantity">The rateQuantity, if present, SHALL contain exactly one [1..1] @unit, which SHALL be selected from ValueSet UnitsOfMeasureCaseSensitive 2.16.840.1.113883.1.11.12839 DYNAMIC (CONF:12607).</sch:assert>
      <sch:assert id="a-12637-c" test="count(cda:repeatNumber)=0 or count(cda:repeatNumber[count(cda:low)=1][count(cda:center)=1])">A.  In "INT" (intent) mood, the repeatNumber defines the number of allowed administrations. For example, a repeatNumber of "3" means that the substance can be administered up to 3 times (CONF:12637).</sch:assert>
      <sch:assert id="a-12638-c" test="count(cda:repeatNumber)=0 or count(cda:repeatNumber[count(cda:low)=1][count(cda:center)=1])">In "EVN" (event) mood, the repeatNumber is the number of occurrences. For example, a repeatNumber of "3" in a substance administration event means that the current administration is the 3rd in a series (CONF:12638).</sch:assert>
      <sch:assert id="a-13849" test="count(cda:effectiveTime)&lt;=1">SHOULD contain zero or one [0..1] effectiveTime (CONF:13849).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.13-warnings">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.13-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-8250" test="not(cda:targetSiteCode) or count(cda:targetSiteCode) &gt;= 0">SHOULD contain zero or more [0..*] targetSiteCode (CONF:8250).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.57-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.57-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.22.4.2-warnings-abstract" />
      <sch:assert id="a-16700-c" test="count(cda:value[@xsi-type='PQ'])=0 or count(cda:value[@xsi-type='PQ'])=1">If xsi:type=PQ, then @units shall be drawn from Unified Code for Units of Measure (UCUM) 2.16.840.1.113883.6.8 code system. Additional constraint is dependent on criteria in the corresponding eMeasure (CONF:16700).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.2.1-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.2.1-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.17.2.4-warnings-abstract" />
      <sch:assert id="a-12833" test="count(cda:entry) &gt;= 0">SHOULD contain zero or more [0..*] entry (CONF:12833) such that it</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.98-warnings">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.98-warnings-abstract" abstract="true">
      <sch:assert id="a-12998-c" test="cda:reference/cda:externalDocument/cda:text">This text is the title of the eMeasure (CONF:12998).</sch:assert>
    </sch:rule>
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.98-12982-branch-12982-warnings-abstract" abstract="true">
      <sch:assert id="a-12997-branch-12982" test="cda:externalDocument[count(cda:text)&lt;=1]">This externalDocument SHOULD contain zero or one [0..1] text (CONF:12997).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.97-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.97-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.24.3.98-warnings-abstract" />
      <sch:assert id="a-12866-c" test="count(cda:reference/cda:externalDocument/cda:text) = 1">This text SHALL equal the title of the eMeasure (CONF:12866).</sch:assert>
      <sch:assert id="a-12868-c" test="count(cda:reference/cda:externalDocument/cda:setId) = 1">This setId SHALL equal the QualityMeasureDocument/setId which is the eMeasure version neutral id (CONF:12868).</sch:assert>
      <sch:assert id="a-12870-c" test="count(cda:reference/cda:externalDocument/cda:versionNumber) = 1">The version number SHALL equal the sequential eMeasure Version number (CONF:12870).</sch:assert>
      ...
      <sch:assert id="a-16688-c" test="count(cda:reference[count(cda:externalDocument[count(cda:id)&gt;0])=1])=1">This identifier SHALL be equal to a population criterion identifier in the referenced eMeasure. (This is necessary because a referenced eMeasure can have multiple numerator populations) (CONF:16688).</sch:assert>
      ...
      <sch:assert id="a-16692-c" test="count(cda:component)=0 or count(cda:component/cda:observation/cda:referenceRange) = 1">The referenceRange is used to indicate the probability that the patient would meet the corresponding population criteria. It is relevant for outcome measures, where predictive models allow for calculating the probability that a patient would meet the criteria of a given population (CONF:16692).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.1.2-warnings">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.1.2-16579-branch-16579-warnings-abstract" abstract="true">
      <sch:assert id="a-16588-branch-16579" test="not(cda:serviceEvent/cda:performer/cda:assignedEntity/cda:id) or cda:serviceEvent/cda:performer/cda:assignedEntity/cda:id[@root='2.16.840.1.113883.4.6']">This id SHOULD contain zero or one [0..1] @root="2.16.840.1.113883.4.6" National Provider ID (CONF:16588).</sch:assert>
      <sch:assert id="a-16592-branch-16579" test="not(cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization) or cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization[count(cda:id[@root='2.16.840.1.113883.4.2'][@extension])=1]">This representedOrganization id/@root coupled with the id/@extension represents the organization's Tax Identification Number (TIN).
...
This representedOrganization SHOULD contain zero or one [0..1] id (CONF:16595) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.4.336" Facility CMS Certification Number (CONF:16596). SHALL contain exactly one [1..1] @extension (CONF:16597).</sch:assert>
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.1.2-16579-branch-16579-warnings" context="cda:ClinicalDocument[cda:templateId/@root='2.16.840.1.113883.10.20.24.1.2']/cda:documentationOf[cda:serviceEvent[@classCode='PCPR'][cda:performer[@typeCode='PRF'][cda:assignedEntity[cda:id][cda:representedOrganization]]]]">
      <sch:extends rule="r-2.16.840.1.113883.10.20.24.1.2-16579-branch-16579-warnings-abstract" />
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.100-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.100-warnings-abstract" abstract="true">
      <sch:assert id="a-13379" test="cda:participantRole[count(cda:addr) &gt;= 0]">This participantRole SHOULD contain zero or more [0..*] addr (CONF:13379).</sch:assert>
      <sch:assert id="a-13380" test="cda:participantRole[count(cda:telecom) &gt;= 0]">This participantRole SHOULD contain zero or more [0..*] telecom (CONF:13380).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.12-warnings">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.12-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-8301" test="not(cda:performer) or count(cda:performer) &gt;= 0">SHOULD contain zero or more [0..*] performer (CONF:8301).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.30-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.30-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.24.3.104-warnings-abstract" />
      <sch:assert id="a-13668" test="cda:effectiveTime[count(cda:high)&lt;=1]">This effectiveTime SHOULD contain zero or one [0..1] high (CONF:13668).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.20-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.20-warnings-abstract" abstract="true">
      <sch:extends rule="r-2.16.840.1.113883.10.20.22.4.2-warnings-abstract" />
      <sch:assert id="a-16696-c" test="count(cda:value[@xsi-type='PQ'])=0 or count(cda:value[@xsi-type='PQ'])=1">If xsi:type=PQ, then @units shall be drawn from Unified Code for Units of Measure (UCUM) 2.16.840.1.113883.6.8 code system. Additional constraint is dependent on criteria in the corresponding eMeasure (CONF:16696).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.18-warnings">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.18-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-10565-c" test="not(cda:performer/cda:assignedEntity) or count(cda:performer/cda:assignedEntity/cda:addr[not(count(cda:city)=1 and count(cda:streetAddressLine)&gt;=1 and count(cda:streetAddressLine)&lt;=4 and (cda:country!='US' or (count(cda:state)=1 and count(cda:postalCode)=1)))])=0">The content of addr SHALL be a conformant US Realm Address (AD.US.FIELDED) (2.16.840.1.113883.10.20.22.5.2) (CONF:10565).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.22.4.45-warnings">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.22.4.45-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-15249-c" test="count(cda:subject/cda:relatedSubject/cda:subject/sdtc:id)&gt;=0">The subject SHOULD contain zero or more [0..*] sdtc:id. The prefix sdtc: SHALL be bound to the namespace ?urn:hl7-org:sdtc?. The use of the namespace provides a necessary extension to CDA R2 for the use of the id element (CONF:15249).</sch:assert>
