...
<sch:schema xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  xmlns:cda="urn:hl7-org:v3" xmlns="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
  ...
  <sch:pattern id="document-errors">
    <sch:rule context="cda:ClinicalDocument">
      <sch:assert test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.1.1'])=1">This
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.1.1-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.1.1-errors-abstract" abstract="true">
      <sch:assert id="a-17210" test="count(cda:code[@codeSystem='2.16.840.1.113883.6.1'])=1">SHALL
        contain exactly one [1..1] code (CodeSystem: LOINC 2.16.840.1.113883.6.1 STATIC)
        (CONF:17210).</sch:assert>
      ...
      <sch:assert id="a-17239" test="count(cda:languageCode)=1">SHALL contain exactly one [1..1]
        languageCode (CONF:17239).</sch:assert>
      ...
      <sch:assert id="a-18158"
        test="count(cda:author[count(cda:assignedAuthor)=1][count(cda:time)=1]) &gt; 0">The CDA
        ...
        (CONF:18158).</sch:assert>
      <sch:assert id="a-18163"
        test="count(cda:author[count(cda:time)=1][count(cda:assignedAuthor[count(cda:assignedAuthoringDevice)
        &lt; 2][count(cda:assignedPerson) &lt; 2][count(cda:representedOrganization)=1])=1]) &gt; 0"
        >The CDA standard requires an author with an identifier. In addition, the QRDA Category III
        ...
        (CONF:18163).</sch:assert>
      <sch:assert id="a-18165"
        test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization[count(cda:id)
        &gt; 0]">This representedCustodianOrganization SHALL contain at least one [1..*] id
      ...
      <sch:assert id="a-18171" test="not(cda:documentationOf) or
        cda:documentationOf[count(cda:serviceEvent)=1]">The documentationOf, if present, SHALL
        contain exactly one [1..1] serviceEvent (CONF:18171).</sch:assert>
      <sch:assert id="a-18172" test="not(cda:documentationOf/cda:serviceEvent) or
        cda:documentationOf/cda:serviceEvent[@classCode='PCPR']">This serviceEvent SHALL contain
        exactly one [1..1] @classCode="PCPR" Care Provision (CodeSystem: HL7ActClass
        2.16.840.1.113883.5.6 STATIC) (CONF:18172).</sch:assert>
      <sch:assert id="a-18173" test="not(cda:documentationOf/cda:serviceEvent) or
        cda:documentationOf/cda:serviceEvent[count(cda:performer) &gt; 0]">This serviceEvent SHALL
        contain at least one [1..*] performer (CONF:18173).</sch:assert>
      <sch:assert id="a-18174" test="not(cda:documentationOf/cda:serviceEvent/cda:performer) or
        cda:documentationOf/cda:serviceEvent/cda:performer[@typeCode='PRF']">Such performers SHALL
        contain exactly one [1..1] @typeCode="PRF" Performer (CodeSystem: HL7ParticipationType
        2.16.840.1.113883.5.90 STATIC) (CONF:18174).</sch:assert>
      <sch:assert id="a-18176" test="not(cda:documentationOf/cda:serviceEvent/cda:performer) or
        cda:documentationOf/cda:serviceEvent/cda:performer[count(cda:assignedEntity)=1]">Such
        performers SHALL contain exactly one [1..1] assignedEntity (CONF:18176).</sch:assert>
      <sch:assert id="a-18180"
        test="not(cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity) or
      ...
      <sch:assert id="a-18262"
        ...
        or
        cda:author/cda:assignedAuthor[cda:time]/cda:assignedAuthoringDevice[cda:representedOrganization][cda:assignedPerson][count(cda:softwareName)=1]"
      ...
      <sch:assert id="a-18302"
        test="not(cda:participant[@typeCode='DEV'][count(cda:associatedEntity)=1]) or
        cda:participant[@typeCode='DEV'][count(cda:associatedEntity)=1]">The generic participant
        ...
        associatedEntity (CONF:18302).</sch:assert>
      <sch:assert id="a-18303" test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity) or
        cda:participant[@typeCode='DEV']/cda:associatedEntity[@classCode='RGPR']">This
      ...
      <sch:assert id="a-18305"
        test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity[count(cda:id[@root='2.16.840.1.113883.3.2074.1'])
        &lt; 2]) or
        cda:participant[@typeCode='DEV']/cda:associatedEntity[count(cda:id[@root='2.16.840.1.113883.3.2074.1'])
        &lt; 2]">If the EHR has an ONC Certification Number, the value of the root attribute is as
        ...
        Certification Number (CONF:18305).</sch:assert>
      <sch:assert id="a-18308" test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity) or
        cda:participant[@typeCode='DEV']/cda:associatedEntity[count(cda:code)=1]">This
        associatedEntity SHALL contain exactly one [1..1] code (CONF:18308).</sch:assert>
      <sch:assert id="a-18309"
        test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity/cda:code) or
        cda:participant[@typeCode='DEV']/cda:associatedEntity/cda:code[@code='129465004' and
        @codeSystem='2.16.840.1.113883.6.96']">This code SHALL contain exactly one [1..1]
        @code="129465004" medical record, device (CodeSystem: SNOMED-CT 2.16.840.1.113883.6.96
        STATIC) (CONF:18309).</sch:assert>
      <sch:assert id="a-18360" test="not(cda:authorization) or
        cda:authorization[count(cda:consent)=1]">The authorization, if present, SHALL contain
        exactly one [1..1] consent (CONF:18360).</sch:assert>
      <sch:assert id="a-18361" test="not(cda:authorization/cda:consent) or
        cda:authorization/cda:consent[count(cda:id)=1]">The consent/id is the identifier of the
        consent given by the eligible provider. This consent SHALL contain exactly one [1..1] id
        (CONF:18361).</sch:assert>
      <sch:assert id="a-18363" test="not(cda:authorization/cda:consent) or
        cda:authorization/cda:consent[count(cda:code[@codeSystem='2.16.840.1.113883.6.96'])=1]">This
        consent SHALL contain exactly one [1..1] code (CodeSystem: SNOMED-CT 2.16.840.1.113883.6.96
        STATIC) (CONF:18363).</sch:assert>
      <sch:assert id="a-18364" test="not(cda:authorization/cda:consent) or
        cda:authorization/cda:consent[count(cda:statusCode)=1]">This consent SHALL contain exactly
        one [1..1] statusCode (CONF:18364).</sch:assert>
      <sch:assert id="a-18381"
        test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity[count(cda:id[@root='2.16.840.1.113883.3.249.21'])
        &lt; 2]) or
        cda:participant[@typeCode='DEV']/cda:associatedEntity[count(cda:id[@root='2.16.840.1.113883.3.249.21'])
        &lt; 2]">If the EHR has a CMS Security Code (a unique identifier assigned by CMS for each
      ...
      <sch:assert id="a-19474"
        test="not(cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity) or
        cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity[count(cda:id) &gt; 0]"
        >This assignedEntity SHALL contain at least one [1..*] id (CONF:19474).</sch:assert>
      <sch:assert id="a-19549" test="cda:code[@code='55184-6' and
        @codeSystem='2.16.840.1.113883.6.1']">This code SHALL contain exactly one [1..1]
        @code="55184-6" " Quality Reporting Document Architecture Calculated Summary Report
        (CodeSystem: LOINC 2.16.840.1.113883.6.1) (CONF:19549).</sch:assert>
      <sch:assert id="a-19550" test="not(cda:authorization/cda:consent/cda:code) or
        cda:authorization/cda:consent/cda:code[@code='425691002' and
        @codeSystem='2.16.840.1.113883.6.96']">This code SHALL contain exactly one [1..1]
        @code="425691002" Consent given for electronic record sharing (CodeSystem: SNOMED-CT
        2.16.840.1.113883.6.96) (CONF:19550).</sch:assert>
      <sch:assert id="a-19551" test="not(cda:authorization/cda:consent/cda:statusCode) or
        cda:authorization/cda:consent/cda:statusCode[@code='completed']">This statusCode SHALL
        contain exactly one [1..1] @code="completed" Completed (CodeSystem: ActStatus
        2.16.840.1.113883.5.14) (CONF:19551).</sch:assert>
      <sch:assert id="a-19667" test="cda:author/cda:assignedAuthor[count(cda:assignedPerson)=1 or
        count(cda:assignedAuthoringDevice)=1]">The CDA standard requires an author with an
        ...
        assignedAuthor/assignedAuthoringDevice (CONF:19667).</sch:assert>
      <sch:assert id="a-19669" test="cda:languageCode[@code]">This languageCode SHALL contain
        exactly one [1..1] @code, which SHALL be selected from ValueSet Language
        2.16.840.1.113883.1.11.11526 DYNAMIC (CONF:19669).</sch:assert>
      <sch:assert id="a-19670" test="cda:legalAuthenticator[count(cda:assignedEntity)=1]">This
        legalAuthenticator SHALL contain exactly one [1..1] assignedEntity
        (CONF:19670).</sch:assert>
      <sch:assert id="a-19672"
        test="not(cda:legalAuthenticator/cda:assignedEntity/cda:representedOrganization) or
        cda:legalAuthenticator/cda:assignedEntity/cda:representedOrganization[count(cda:id) &gt; 0]"
        >The representedOrganization, if present, SHALL contain at least one [1..*] id
        (CONF:19672).</sch:assert>
      <sch:assert id="a-20954" test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity) or
        cda:participant[@typeCode='DEV']/cda:associatedEntity[count(cda:id) &gt; 0]">This
        associatedEntity SHALL contain at least one [1..*] id (CONF:20954).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.2.2-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.2.2-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-12799" test="count(cda:title[translate(text(), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ',
        'abcdefghijklmnopqrstuvwxyz')='measure section'])=1">SHALL contain exactly one [1..1]
        title="Measure Section" (CONF:12799).</sch:assert>
      <sch:assert id="a-12800" test="count(cda:text)=1">SHALL contain exactly one [1..1] text
        (CONF:12800).</sch:assert>
      <sch:assert id="a-16677"
        test="count(cda:entry[count(cda:organizer[cda:templateId/@root='2.16.840.1.113883.10.20.24.3.98'])=1])
        &gt; 0">SHALL contain at least one [1..*] entry (CONF:13003) such that it SHALL contain
        exactly one [1..1] Measure Reference (templateId:2.16.840.1.113883.10.20.24.3.98)
        (CONF:16677).</sch:assert>
      <sch:assert id="a-19230" test="cda:code[@code='55186-1' and
        @codeSystem='2.16.840.1.113883.6.1']">This code SHALL contain exactly one [1..1]
        @code="55186-1" Measure Section (CodeSystem: LOINC 2.16.840.1.113883.6.1 STATIC)
        (CONF:19230).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.2.1-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.2.1-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-17907"
        test="count(cda:entry[count(cda:organizer[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.1'])=1])
        &gt; 0">SHALL contain at least one [1..*] entry (CONF:17906) such that it SHALL contain
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.3-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.3-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-18393" test="not(cda:referenceRange) or
        cda:referenceRange[count(cda:observationRange)=1]">The referenceRange, if present, SHALL
        contain exactly one [1..1] observationRange (CONF:18393).</sch:assert>
      <sch:assert id="a-18394" test="not(cda:referenceRange/cda:observationRange) or
        cda:referenceRange/cda:observationRange[count(cda:value[@xsi:type='INT'])=1]">This
        observationRange SHALL contain exactly one [1..1] value with @xsi:type="INT"
        (CONF:18394).</sch:assert>
      <sch:assert id="a-19508" test="cda:code[@code='MSRAGG' and
        @codeSystem='2.16.840.1.113883.5.4']">This code SHALL contain exactly one [1..1]
        @code="MSRAGG" rate aggregation (CodeSystem: ActCode 2.16.840.1.113883.5.4)
        (CONF:19508).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.2-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.2-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-18390" test="not(cda:referenceRange) or
        cda:referenceRange[count(cda:observationRange)=1]">The referenceRange, if present, SHALL
        contain exactly one [1..1] observationRange (CONF:18390).</sch:assert>
      <sch:assert id="a-18391" test="not(cda:referenceRange/cda:observationRange) or
        cda:referenceRange/cda:observationRange[count(cda:value)=1]">This observationRange SHALL
        contain exactly one [1..1] value (CONF:18391).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.4-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.4-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-17578" test="cda:code[@code='ASSERTION' and
        @codeSystem='2.16.840.1.113883.5.4']">This code SHALL contain exactly one [1..1]
        @code="ASSERTION" Assertion (CodeSystem: ActCode 2.16.840.1.113883.5.4 STATIC)
        (CONF:17578).</sch:assert>
      ...
      <sch:assert id="a-18259" test="not(testable)">If this Reporting Stratum references an
        ...
        element (CONF:18259).</sch:assert>
      <sch:assert id="a-19513"
        test="not(cda:entryRelationship[count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.2'])=1])
        or
        cda:entryRelationship[count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.2'])=1]"
        >The Continuous Variable template may also be nested inside the Reporting Stratum Template
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.5-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.5-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-17920"
        test="not(cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.4'])=1])
        or
        cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.4'])=1]"
      ...
      <sch:assert id="a-18138"
        test="not(cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.6'])=1])
        or
        cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.6'])=1]"
      ...
      <sch:assert id="a-18149"
        test="not(cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.7'])=1])
        or
        cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.7'])=1]"
      ...
      <sch:assert id="a-18150"
        test="not(cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.8'])=1])
        or
        cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.8'])=1]"
      ...
      <sch:assert id="a-18151"
        test="not(cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.9'])=1])
        or
        cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.9'])=1]"
      ...
      <sch:assert id="a-18152"
        test="not(cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.10'])=1])
        or
        cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.10'])=1]"
      ...
      <sch:assert id="a-18153"
        test="not(cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.2'])=1])
        or
        cda:entryRelationship[@typeCode='COMP'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.2'])=1]"
      ...
      <sch:assert id="a-18198" test="cda:code[@code='ASSERTION' and
        @codeSystem='2.16.840.1.113883.5.4']">This code SHALL contain exactly one [1..1]
        @code="ASSERTION" Assertion (CodeSystem: ActCode 2.16.840.1.113883.5.4 STATIC)
        (CONF:18198).</sch:assert>
      <sch:assert id="a-18199" test="count(cda:statusCode)=1">SHALL contain exactly one [1..1]
        statusCode (CodeSystem: ActStatus 2.16.840.1.113883.5.14 STATIC) (CONF:18199).</sch:assert>
      ...
      <sch:assert id="a-19555" test="cda:statusCode[@code='completed']">This statusCode SHALL
        contain exactly one [1..1] @code="completed" Completed (CodeSystem: ActStatus
        2.16.840.1.113883.5.14) (CONF:19555).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.98-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.98-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-12984"
        test="cda:reference[@typeCode='REFR'][cda:externalDocument[@classCode='DOC']]">SHALL contain
      ...
      <sch:assert id="a-12986"
        test="count(cda:reference[@typeCode='REFR']/cda:externalDocument[count(cda:id[@root]) &gt;
        0]) &gt; 0">This externalDocument SHALL contain exactly one [1..1] id (CONF:12985) such that
        it SHALL contain exactly one [1..1] @root (CONF:12986).</sch:assert>
      ...
      <sch:assert id="a-12998" test="cda:reference/cda:externalDocument/cda:text">This text is the
        title of the eMeasure (CONF:12998).</sch:assert>
      <sch:assert id="a-19533"
        test="count(cda:templateId[@root='2.16.840.1.113883.10.20.24.3.98'])=1">SHALL contain
        exactly one [1..1] templateId (CONF:19532) such that it SHALL contain exactly one [1..1]
        @root="2.16.840.1.113883.10.20.24.3.98" (CONF:19533).</sch:assert>
      <sch:assert id="a-19534"
        test="cda:reference[@typeCode='REFR']/cda:externalDocument[@classCode]">This
        externalDocument SHALL contain exactly one [1..1] @classCode (CodeSystem: HL7ActClass
        2.16.840.1.113883.5.6) (CONF:19534).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.1-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.1-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-17889" test="count(cda:statusCode)=1">SHALL contain exactly one [1..1]
        statusCode (CONF:17889).</sch:assert>
      <sch:assert id="a-17892"
        ...
        (CodeSystem: HL7ActClass 2.16.840.1.113883.5.6 STATIC) (CONF:17892).</sch:assert>
      <sch:assert id="a-17904"
        test="not(cda:component[count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.14'])=1])
        or
        cda:component[count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.14'])=1]"
        >MAY contain zero or more [0..*] component (CONF:17903) such that it SHALL contain exactly
        one [1..1] Performance Rate for Proportion Measure
        (templateId:2.16.840.1.113883.10.20.27.3.14) (CONF:17904).</sch:assert>
      <sch:assert id="a-18193" test="count(cda:reference[@typeCode='REFR']/cda:externalDocument) =
        count(cda:reference[@typeCode='REFR']/cda:externalDocument[cda:id[@root]])">This
        externalDocument SHALL contain exactly one [1..1] id (CONF:18192) such that it SHALL contain
        exactly one [1..1] @root (CONF:18193).</sch:assert>
      <sch:assert id="a-18354" test="not(cda:reference/cda:externalObservation) or
        cda:reference/cda:externalObservation">In the case that an eMeasure is part of a measure set
        ...
        [1..1] externalObservation (CONF:18354).</sch:assert>
      <sch:assert id="a-18355" test="count(cda:reference/cda:externalObservation) =
        count(cda:reference/cda:externalObservation[cda:id])">This externalObservation SHALL contain
        at least one [1..*] id (CONF:18355).</sch:assert>
      <sch:assert id="a-18356" test="not(testable)">This id SHALL equal the id of the corresponding
        measure set definition within the eMeasure (CONF:18356).</sch:assert>
      <sch:assert id="a-18357" test="not(cda:reference/cda:externalObservation) or
        cda:reference/cda:externalObservation[cda:code[@code='55185-3'][@codeSystem='2.16.840.1.113883.6.1']]"
        >This externalObservation SHALL contain exactly one [1..1] code (CodeSystem: LOINC
        2.16.840.1.113883.6.1 STATIC) (CONF:18357).</sch:assert>
      <sch:assert id="a-18358" test="not(cda:reference/cda:externalObservation) or
        cda:reference/cda:externalObservation[count(cda:text)=1]">This externalObservation SHALL
        contain exactly one [1..1] text (CONF:18358).</sch:assert>
      <sch:assert id="a-18424"
        test="count(cda:component[count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.15'])=1])
        &lt; 2">MAY contain zero or one [0..1] component (CONF:18423) such that it SHALL contain
      ...
      <sch:assert id="a-18426"
        test="count(cda:component[count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.5'])=1])
        &gt; 0">SHALL contain at least one [1..*] component (CONF:18425) such that it SHALL contain
        exactly one [1..1] Measure Data (templateId:2.16.840.1.113883.10.20.27.3.5)
        (CONF:18426).</sch:assert>
      <sch:assert id="a-19548"
        test="cda:reference[@typeCode='REFR']/cda:externalDocument[@classCode]">This
        externalDocument SHALL contain exactly one [1..1] @classCode (CodeSystem: HL7ActClass
        2.16.840.1.113883.5.6) (CONF:19548).</sch:assert>
      <sch:assert id="a-19552" test="cda:statusCode[@code='completed']">This statusCode SHALL
        contain exactly one [1..1] @code="completed" Completed (CodeSystem: ActStatus
        2.16.840.1.113883.5.14) (CONF:19552).</sch:assert>
      <sch:assert id="a-19553"
        test="not(cda:reference[@typeCode='REFR']/cda:externalDocument/cda:code) or
        cda:reference[@typeCode='REFR']/cda:externalDocument/cda:code[@code='57024-2' and
        @codeSystem='2.16.840.1.113883.6.1']">The code, if present, SHALL contain exactly one [1..1]
        @code="57024-2" Health Quality Measure Document (CodeSystem: LOINC 2.16.840.1.113883.6.1)
        (CONF:19553).</sch:assert>
      <sch:assert id="a-19554" test="not(tested)">This code SHALL contain exactly one [1..1]
        @code="55185-3" measure set (CodeSystem: LOINC 2.16.840.1.113883.6.1)
        (CONF:19554).</sch:assert>
      <sch:assert id="a-19660" test="not(testable)">This externalDocument SHALL contain exactly one
        ...
        for eMeasure (i.e. QualityMeasureDocument/id) (CONF:19660).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.24.3.55-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.24.3.55-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-14029" test="cda:code[@code='48768-6' and
        @codeSystem='2.16.840.1.113883.6.1']">This code SHALL contain exactly one [1..1]
        @code="48768-6" Payment source (CodeSystem: LOINC 2.16.840.1.113883.6.1 STATIC)
        (CONF:14029).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.9-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.9-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-21155" test="@classCode='OBS'">SHALL contain exactly one [1..1] @classCode="OBS" (CodeSystem: HL7ActClass 2.16.840.1.113883.5.6 STATIC) (CONF:21155).</sch:assert>      
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.8-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.8-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-18228" test="cda:code[@code='103579009' and
        @codeSystem='2.16.840.1.113883.6.96']">This code SHALL contain exactly one [1..1]
        @code="103579009" Race (CodeSystem: SNOMED-CT 2.16.840.1.113883.6.96)
        (CONF:18228).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.11-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.11-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-21154" test="@moodCode='EVN'">SHALL contain exactly one [1..1]
        @moodCode="EVN" (CodeSystem: ActMood 2.16.840.1.113883.5.1001 STATIC)
        (CONF:21154).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.17.2.1-errors">
    ...
    <sch:rule id="r-2.16.840.1.113883.10.20.17.2.1-errors-abstract" abstract="true">
      <sch:assert id="a-4142" test="count(cda:title[translate(text(), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ',
        'abcdefghijklmnopqrstuvwxyz')='reporting parameters'])=1">SHALL contain exactly one [1..1]
        title="Reporting Parameters" (CONF:4142).</sch:assert>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.2.2-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.2.2-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-18330"
        test="not(cda:entry[count(cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.11'])=1])
        or
        cda:entry[count(cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.11'])=1]"
        >MAY contain zero or more [0..*] entry (CONF:18328) such that it SHALL contain exactly one
        [1..1] Service Encounter (templateId:2.16.840.1.113883.10.20.27.3.11)
        (CONF:18330).</sch:assert>
      <sch:assert id="a-18428"
        test="count(cda:entry[@typeCode='DRIV'][count(cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.17.3.8'])=1])
        &lt; 2">SHOULD contain zero or one [0..1] entry (CONF:18325) such that it SHALL contain
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.14-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.14-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-18401" test="not(cda:referenceRange) or
        cda:referenceRange[count(cda:observationRange)=1]">The referenceRange, if present, SHALL
        contain exactly one [1..1] observationRange (CONF:18401).</sch:assert>
      <sch:assert id="a-18402" test="not(cda:referenceRange/cda:observationRange) or
        cda:referenceRange/cda:observationRange[count(cda:value[@xsi:type='REAL'])=1]">This
      ...
      <sch:assert id="a-19649" test="count(cda:templateId)=1">SHALL contain exactly one [1..1]
        templateId (CONF:19649).</sch:assert>
      <sch:assert id="a-19650" test="cda:templateId[@root='2.16.840.1.113883.10.20.27.3.14']">This
        templateId SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.14"
        (CONF:19650).</sch:assert>
      <sch:assert id="a-19652" test="not(cda:reference) or cda:reference[@typeCode='REFR']">The
        reference, if present, SHALL contain exactly one [1..1] @typeCode="REFR" refers to
        (CodeSystem: HL7ActRelationshipType 2.16.840.1.113883.5.1002) (CONF:19652).</sch:assert>
      <sch:assert id="a-19653" test="not(cda:reference) or
        cda:reference[count(cda:externalObservation)=1]">The reference, if present, SHALL contain
        exactly one [1..1] externalObservation (CONF:19653).</sch:assert>
      <sch:assert id="a-19654" test="not(cda:reference/cda:externalObservation) or
        cda:reference/cda:externalObservation[@classCode]">This externalObservation SHALL contain
        exactly one [1..1] @classCode (CodeSystem: HL7ActClass 2.16.840.1.113883.5.6)
        (CONF:19654).</sch:assert>
      <sch:assert id="a-19655" test="not(tested)">The externalObservationID contains the ID of the
        numerator in the referenced eMeasure. This externalObservation SHALL contain exactly one
        [1..1] id (CONF:19655).</sch:assert>
      <sch:assert id="a-19656" test="not(cda:reference/cda:externalObservation/cda:id) or
        cda:reference/cda:externalObservation/cda:id[@root]">This id SHALL contain exactly one
        [1..1] @root (CONF:19656).</sch:assert>
      <sch:assert id="a-19657" test="not(cda:reference/cda:externalObservation) or
        cda:reference/cda:externalObservation[count(cda:code)=1]">This externalObservation SHALL
        contain exactly one [1..1] code (CONF:19657).</sch:assert>
      <sch:assert id="a-19658" test="not(cda:reference/cda:externalObservation/cda:code) or
        cda:reference/cda:externalObservation/cda:code[@code='NUMER' and
        @codeSystem='2.16.840.1.113883.5.1063']">This code SHALL contain exactly one [1..1]
        @code="NUMER" Numerator (CodeSystem: ObservationValue 2.16.840.1.113883.5.1063)
        (CONF:19658).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.15-errors">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.15-errors-abstract" abstract="true">
      ...
      <sch:assert id="a-18414" test="cda:code[@code='72509-3' and
        @codeSystem='2.16.840.1.113883.6.1']">This code SHALL contain exactly one [1..1]
        @code="72509-3" Reporting Rate (CodeSystem: LOINC 2.16.840.1.113883.6.1 STATIC)
        (CONF:18414).</sch:assert>
      ...
      <sch:assert id="a-18417" test="not(cda:referenceRange) or
        cda:referenceRange[count(cda:observationRange)=1]">The referenceRange, if present, SHALL
        contain exactly one [1..1] observationRange (CONF:18417).</sch:assert>
      <sch:assert id="a-18418" test="not(cda:referenceRange/cda:observationRange) or
        cda:referenceRange/cda:observationRange[count(cda:value[@xsi:type='REAL'])=1]">This
        observationRange SHALL contain exactly one [1..1] value with @xsi:type="REAL"
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.1.1-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.1.1-warnings-abstract" abstract="true">
      <sch:assert id="a-18166"
        test="cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization[count(cda:name)
        &lt; 2]">This representedCustodianOrganization SHOULD contain zero or one [0..1] name
      ...
      <sch:assert id="a-19659"
        test="not(cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization)
        or
        cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization[not(cda:name)
        or cda:name]">This representedOrganization SHOULD contain zero or more [0..*] name
        (CONF:19659).</sch:assert>
      <sch:assert id="a-19673"
        test="not(cda:legalAuthenticator/cda:assignedEntity/cda:representedOrganization) or
        cda:legalAuthenticator/cda:assignedEntity/cda:representedOrganization[count(cda:name) &lt;
        2]">The representedOrganization, if present, SHOULD contain zero or one [0..1] name
        (CONF:19673).</sch:assert>
    </sch:rule>
  ...
  <sch:pattern id="p-2.16.840.1.113883.10.20.27.3.1-warnings">
    <sch:rule id="r-2.16.840.1.113883.10.20.27.3.1-warnings-abstract" abstract="true">
      ...
      <sch:assert id="a-17896"
        test="cda:reference[@typeCode='REFR']/cda:externalDocument[count(cda:code[@codeSystem='2.16.840.1.113883.6.1'])
        &lt; 2]">This externalDocument SHOULD contain zero or one [0..1] code (CodeSystem: LOINC
        2.16.840.1.113883.6.1 STATIC) (CONF:17896).</sch:assert>
