...
<axsl:choose><axsl:when test="count(cda:languageCode)=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:languageCode)=1"><axsl:attribute name="id">a-17239</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1]
        ...
        DYNAMIC (CONF:17239).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization[count(cda:id[@root='2.16.840.1.113883.4.336' and @extension]) &lt; 2]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization[count(cda:id[@root='2.16.840.1.113883.4.336' and @extension]) &lt; 2]"><axsl:attribute name="id">a-18185</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This representedOrganization id/@root coupled with the id/@extension represents the
        ...
        (CONF:18185).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization[count(cda:id[@root='2.16.840.1.113883.4.2' and @extension]) &lt; 2]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:representedOrganization[count(cda:id[@root='2.16.840.1.113883.4.2' and @extension]) &lt; 2]"><axsl:attribute name="id">a-18190</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This representedOrganization id/@root coupled with the id/@extension can be used to
        ...
        (CONF:18190).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="not(cda:participant[@typeCode='DEV'][count(cda:associatedEntity)=1]) or cda:participant[@typeCode='DEV'][count(cda:associatedEntity)=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:participant[@typeCode='DEV'][count(cda:associatedEntity)=1]) or cda:participant[@typeCode='DEV'][count(cda:associatedEntity)=1]"><axsl:attribute name="id">a-18302</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>The generic participant with a participationType of device and an associatedEntity class
        ...
        exactly one [1..1] associatedEntity (CONF:18302).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity) or cda:participant[@typeCode='DEV']/cda:associatedEntity[@classCode='RGPR']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity) or cda:participant[@typeCode='DEV']/cda:associatedEntity[@classCode='RGPR']"><axsl:attribute name="id">a-18303</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This associatedEntity SHALL contain exactly one [1..1] @classCode="RGPR" regulated product
        (CodeSystem: HL7ActClass 2.16.840.1.113883.5.6 STATIC) (CONF:18303).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity) or cda:participant[@typeCode='DEV']/cda:associatedEntity[count(cda:code)=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity) or cda:participant[@typeCode='DEV']/cda:associatedEntity[count(cda:code)=1]"><axsl:attribute name="id">a-18308</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This associatedEntity SHALL contain exactly one [1..1] code (CONF:18308).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity/cda:code) or cda:participant[@typeCode='DEV']/cda:associatedEntity/cda:code[@code='129465004' and @codeSystem='2.16.840.1.113883.6.96']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:participant[@typeCode='DEV']/cda:associatedEntity/cda:code) or cda:participant[@typeCode='DEV']/cda:associatedEntity/cda:code[@code='129465004' and @codeSystem='2.16.840.1.113883.6.96']"><axsl:attribute name="id">a-18309</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL contain exactly one [1..1] @code="129465004" medical record, device
        (CodeSystem: SNOMED-CT 2.16.840.1.113883.6.96 STATIC) (CONF:18309).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(cda:authorization) or cda:authorization[count(cda:consent)=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:authorization) or cda:authorization[count(cda:consent)=1]"><axsl:attribute name="id">a-18360</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>The authorization,
        if present, SHALL contain exactly one [1..1] consent (CONF:18360).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(cda:authorization/cda:consent) or cda:authorization/cda:consent[count(cda:id)=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:authorization/cda:consent) or cda:authorization/cda:consent[count(cda:id)=1]"><axsl:attribute name="id">a-18361</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>The consent/id is the identifier of the consent given by the eligible provider. This
        consent SHALL contain exactly one [1..1] id (CONF:18361).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(cda:authorization/cda:consent) or cda:authorization/cda:consent[count(cda:code[@code='425691002'][@codeSystem='2.16.840.1.113883.6.96'])=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:authorization/cda:consent) or cda:authorization/cda:consent[count(cda:code[@code='425691002'][@codeSystem='2.16.840.1.113883.6.96'])=1]"><axsl:attribute name="id">a-18363</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This consent SHALL contain exactly one [1..1] code="425691002" consent given for electronic
        record sharing (CodeSystem: SNOMED-CT 2.16.840.1.113883.6.96 STATIC)
        (CONF:18363).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(cda:authorization/cda:consent) or cda:authorization/cda:consent[count(cda:statusCode[@code='completed'])=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:authorization/cda:consent) or cda:authorization/cda:consent[count(cda:statusCode[@code='completed'])=1]"><axsl:attribute name="id">a-18364</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This consent SHALL contain exactly one [1..1] statusCode="completed"
        (CONF:18364).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:legalAuthenticator[count(cda:assignedEntity)=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:legalAuthenticator[count(cda:assignedEntity)=1]"><axsl:attribute name="id">a-19443</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This
        legalAuthenticator SHALL contain exactly one [1..1] assignedEntity
        (CONF:19443).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:legalAuthenticator/cda:assignedEntity[count(cda:id) &gt; 0]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:legalAuthenticator/cda:assignedEntity[count(cda:id) &gt; 0]"><axsl:attribute name="id">a-19444</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This assignedEntity
        SHALL contain at least one [1..*] id (CONF:19444).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:legalAuthenticator/cda:assignedEntity[count(cda:addr) &gt; 0]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:legalAuthenticator/cda:assignedEntity[count(cda:addr) &gt; 0]"><axsl:attribute name="id">a-19447</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This assignedEntity SHALL contain at least one [1..*] US Realm Address (AD.US.FIELDED)
        (templateId:2.16.840.1.113883.10.20.22.5.2) (CONF:19447).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:legalAuthenticator/cda:assignedEntity[count(cda:telecom) &gt; 0]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:legalAuthenticator/cda:assignedEntity[count(cda:telecom) &gt; 0]"><axsl:attribute name="id">a-19448</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This
        assignedEntity SHALL contain at least one [1..*] telecom (CONF:19448).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:legalAuthenticator/cda:assignedEntity[count(cda:assignedPerson)=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:legalAuthenticator/cda:assignedEntity[count(cda:assignedPerson)=1]"><axsl:attribute name="id">a-19450</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This
        assignedEntity SHALL contain exactly one [1..1] assignedPerson (CONF:19450).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:legalAuthenticator/cda:assignedEntity/cda:assignedPerson[count(cda:name) &gt; 0]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:legalAuthenticator/cda:assignedEntity/cda:assignedPerson[count(cda:name) &gt; 0]"><axsl:attribute name="id">a-19451</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This assignedPerson SHALL contain at least one [1..*] US Realm Person Name (PN.US.FIELDED)
        (templateId:2.16.840.1.113883.10.20.22.5.1.1) (CONF:19451).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="not(cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity) or cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity[count(cda:id) &gt; 0]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity) or cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity[count(cda:id) &gt; 0]"><axsl:attribute name="id">a-19474</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This assignedEntity SHALL contain at least one [1..*] id (CONF:19474).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="(cda:author/cda:assignedAuthor/cda:assignedAuthoringDevice) or (cda:author/cda:assignedAuthor/cda:assignedPerson)"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="(cda:author/cda:assignedAuthor/cda:assignedAuthoringDevice) or (cda:author/cda:assignedAuthor/cda:assignedPerson)"><axsl:attribute name="id">a-19512</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>There SHALL be at least one
        author/assignedAuthor/assignedPerson and/or at least one
        author/assignedAuthor/assignedAuthoringDevice.</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='MSRAGG' and @codeSystem='2.16.840.1.113883.5.4']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='MSRAGG' and @codeSystem='2.16.840.1.113883.5.4']"><axsl:attribute name="id">a-19508</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        ...
        2.16.840.1.113883.5.4) (CONF:19508).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='ASSERTION' and @codeSystem='2.16.840.1.113883.5.4']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='ASSERTION' and @codeSystem='2.16.840.1.113883.5.4']"><axsl:attribute name="id">a-17578</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        ...
        2.16.840.1.113883.5.4 STATIC) (CONF:17578).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='ASSERTION' and @codeSystem='2.16.840.1.113883.5.4']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='ASSERTION' and @codeSystem='2.16.840.1.113883.5.4']"><axsl:attribute name="id">a-18198</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        contain exactly one [1..1] @code="ASSERTION" Assertion (CodeSystem: ActCode
        2.16.840.1.113883.5.4 STATIC) (CONF:18198).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(cda:statusCode[@code='completed'])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:statusCode[@code='completed'])=1"><axsl:attribute name="id">a-18199</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain
        ...
        2.16.840.1.113883.5.14 STATIC) (CONF:18199).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(cda:reference/cda:externalDocument/cda:id) &gt; 0"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:reference/cda:externalDocument/cda:id) &gt; 0"><axsl:attribute name="id">a-12987</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:reference/cda:externalDocument/cda:text"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:reference/cda:externalDocument/cda:text"><axsl:attribute name="id">a-12998</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This
        text is the title of the eMeasure (CONF:12998).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(cda:statusCode[@code='completed'])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:statusCode[@code='completed'])=1"><axsl:attribute name="id">a-17889</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain
        exactly one [1..1] statusCode="completed" (CONF:17889).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:reference[@typeCode='REFR']/cda:externalDocument[@classCode='DOC']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:reference[@typeCode='REFR']/cda:externalDocument[@classCode='DOC']"><axsl:attribute name="id">a-17892</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1] reference (CONF:17890) such that it SHALL contain exactly
        ...
        (CONF:17892).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:component[count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.14'])=1]) &lt; 2"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:component[count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.14'])=1]) &lt; 2"><axsl:attribute name="id">a-17904</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>MAY contain zero or one [0..1] component (CONF:17903) such that it SHALL contain exactly
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:reference[@typeCode='REFR']/cda:externalDocument[cda:id[@root]]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:reference[@typeCode='REFR']/cda:externalDocument[cda:id[@root]]"><axsl:attribute name="id">a-18193</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This externalDocument SHALL contain exactly one [1..1] id (CONF:18192) such that it SHALL
        contain exactly one [1..1] @root (CONF:18193).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='184102003' and @codeSystem='2.16.840.1.113883.6.96']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='184102003' and @codeSystem='2.16.840.1.113883.6.96']"><axsl:attribute name="id">a-18214</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        ...
        2.16.840.1.113883.6.96 STATIC) (CONF:18214).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='48768-6' and @codeSystem='2.16.840.1.113883.6.1']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='48768-6' and @codeSystem='2.16.840.1.113883.6.1']"><axsl:attribute name="id">a-14029</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        ...
        2.16.840.1.113883.6.1 STATIC) (CONF:14029).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:statusCode[@code='completed']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:statusCode[@code='completed']"><axsl:attribute name="id">a-18107</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This statusCode SHALL
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:entryRelationship[@typeCode='SUBJ'][@inversionInd='true'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.3'])=1])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:entryRelationship[@typeCode='SUBJ'][@inversionInd='true'][count(cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.3'])=1])=1"><axsl:attribute name="id">a-18111</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1] entryRelationship (CONF:18108) such that it SHALL contain
        exactly one [1..1] @typeCode="SUBJ" Has Subject (CodeSystem: HL7ActRelationshipType
        ...
        (templateId:2.16.840.1.113883.10.20.27.3.3) (CONF:18111).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='103579009' and @codeSystem='2.16.840.1.113883.6.96']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='103579009' and @codeSystem='2.16.840.1.113883.6.96']"><axsl:attribute name="id">a-18228</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        ...
        2.16.840.1.113883.6.96) (CONF:18228).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='364699009' and @codeSystem='2.16.840.1.113883.6.96']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='364699009' and @codeSystem='2.16.840.1.113883.6.96']"><axsl:attribute name="id">a-18221</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        ...
        2.16.840.1.113883.6.96) (CONF:18221).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:value[@xsi:type='CD'])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:value[@xsi:type='CD'])=1"><axsl:attribute name="id">a-18222</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one
        [1..1] value with @xsi:type="CD", where the @code SHALL be selected from ValueSet
        EtnicityGroup 2.16.840.1.114222.4.11.837 DYNAMIC (CONF:18222).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='184100006' and @codeSystem='2.16.840.1.113883.6.96']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='184100006' and @codeSystem='2.16.840.1.113883.6.96']"><axsl:attribute name="id">a-18235</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        ...
        2.16.840.1.113883.6.96 STATIC) (CONF:18235).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<!--PATTERN p-2.16.840.1.113883.10.20.27.3.12-errors-->


	<!--RULE r-2.16.840.1.113883.10.20.27.3.12-errors-->
<axsl:template match="cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.12']" priority="1000" mode="M22"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.12']" id="r-2.16.840.1.113883.10.20.27.3.12-errors"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="@classCode='ENC'"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="@classCode='ENC'"><axsl:attribute name="id">a-18316</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1]
        @classCode="ENC" (CodeSystem: HL7ActClass 2.16.840.1.113883.5.6 STATIC)
        (CONF:18316).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:effectiveTime)=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:effectiveTime)=1"><axsl:attribute name="id">a-18318</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1]
        effectiveTime (CONF:18318).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:effectiveTime[count(cda:high)=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:effectiveTime[count(cda:high)=1]"><axsl:attribute name="id">a-18320</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This effectiveTime SHALL
        contain exactly one [1..1] high (CONF:18320).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.12'])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.12'])=1"><axsl:attribute name="id">a-18372</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain
        exactly one [1..1] templateId (CONF:18371) such that it SHALL contain exactly one [1..1]
        @root="2.16.840.1.113883.10.20.27.3.12" (CONF:18372).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M22"/></axsl:template><axsl:template match="text()" priority="-1" mode="M22"/><axsl:template match="@*|node()" priority="-2" mode="M22"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M22"/></axsl:template>

<!--PATTERN p-2.16.840.1.113883.10.20.17.2.1-errors-->


	<!--RULE r-2.16.840.1.113883.10.20.17.2.1-errors-->
<axsl:template match="cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.17.2.1']" priority="1000" mode="M23"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.17.2.1']" id="r-2.16.840.1.113883.10.20.17.2.1-errors"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:title[translate(text(), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')='reporting parameters'])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:title[translate(text(), 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz')='reporting parameters'])=1"><axsl:attribute name="id">a-4142</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1] title="Reporting Parameters" (CONF:4142).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(cda:entry[@typeCode='DRIV'][count(cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.17.3.8'])=1])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:entry[@typeCode='DRIV'][count(cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.17.3.8'])=1])=1"><axsl:attribute name="id">a-17496</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1] entry (CONF:3277) such that it SHALL contain exactly one
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:code[@code='55187-9'][@codeSystem='2.16.840.1.113883.6.1'])"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:code[@code='55187-9'][@codeSystem='2.16.840.1.113883.6.1'])"><axsl:attribute name="id">a-18191</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain
        exactly one [1..1] code (CONF:18191).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:code[@code='55187-9' and @codeSystem='2.16.840.1.113883.6.1']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='55187-9' and @codeSystem='2.16.840.1.113883.6.1']"><axsl:attribute name="id">a-19229</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        ...
        2.16.840.1.113883.6.1 STATIC) (CONF:19229).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:template match="cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.27.2.2']" priority="1000" mode="M24"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:section[cda:templateId/@root='2.16.840.1.113883.10.20.27.2.2']" id="r-2.16.840.1.113883.10.20.27.2.2-errors"/>
...
<axsl:choose><axsl:when test="cda:code[@code='55187-9' and @codeSystem='2.16.840.1.113883.6.1']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='55187-9' and @codeSystem='2.16.840.1.113883.6.1']"><axsl:attribute name="id">a-19229</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:entry[count(cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.12'])=1]) &lt; 2"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:entry[count(cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.12'])=1]) &lt; 2"><axsl:attribute name="id">a-18330</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>MAY contain zero or one [0..1] entry (CONF:18328) such that it SHALL contain exactly one
...
<axsl:choose><axsl:when test="count(cda:entry[@typeCode='DRIV'][count(cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.17.3.8'])=1]) &lt; 2"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:entry[@typeCode='DRIV'][count(cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.17.3.8'])=1]) &lt; 2"><axsl:attribute name="id">a-18428</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHOULD contain zero or one [0..1] entry (CONF:18325) such that it SHALL contain exactly one
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:entry[count(cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.11'])=1]) &lt; 2"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:entry[count(cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.11'])=1]) &lt; 2"><axsl:attribute name="id">a-18430</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>MAY contain zero or one [0..1] entry (CONF:18429) such that it SHALL contain exactly one
        [1..1] First Encounter (templateId:2.16.840.1.113883.10.20.27.3.11)
        (CONF:18430).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.2.2'])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.2.2'])=1"><axsl:attribute name="id">a-18324</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly
        ...
        @root="2.16.840.1.113883.10.20.27.2.2" (CONF:18324).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M24"/></axsl:template><axsl:template match="text()" priority="-1" mode="M24"/><axsl:template match="@*|node()" priority="-2" mode="M24"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M24"/></axsl:template>

<!--PATTERN p-2.16.840.1.113883.10.20.27.3.14-errors-->


	<!--RULE r-2.16.840.1.113883.10.20.27.3.14-errors-->
<axsl:template match="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.14']" priority="1000" mode="M25"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.14']" id="r-2.16.840.1.113883.10.20.27.3.14-errors"/>
...
<axsl:choose><axsl:when test="count(cda:code)=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:code)=1"><axsl:attribute name="id">a-18397</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1] code
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:code[@code='PERFR-X' and @codeSystem='2.16.840.1.113883.6.1']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='PERFR-X' and @codeSystem='2.16.840.1.113883.6.1']"><axsl:attribute name="id">a-18398</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        contain exactly one [1..1] @code="PERFR-X" Performance Rate (proportion measure)
        (CodeSystem: LOINC 2.16.840.1.113883.6.1 STATIC) (CONF:18398).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:statusCode[@code='completed']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:statusCode[@code='completed']"><axsl:attribute name="id">a-18422</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This statusCode SHALL
        contain exactly one [1..1] @code="completed" completed (CodeSystem: ActStatus
        2.16.840.1.113883.5.14 STATIC) (CONF:18422).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M25"/></axsl:template><axsl:template match="text()" priority="-1" mode="M25"/><axsl:template match="@*|node()" priority="-2" mode="M25"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M25"/></axsl:template>

<!--PATTERN p-2.16.840.1.113883.10.20.27.3.15-errors-->


	<!--RULE r-2.16.840.1.113883.10.20.27.3.15-errors-->
<axsl:template match="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.15']" priority="1000" mode="M26"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.27.3.15']" id="r-2.16.840.1.113883.10.20.27.3.15-errors"/>
...
<axsl:choose><axsl:when test="count(cda:code)=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:code)=1"><axsl:attribute name="id">a-18413</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1] code
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="cda:code[@code='REPR-X' and @codeSystem='2.16.840.1.113883.6.1']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:code[@code='REPR-X' and @codeSystem='2.16.840.1.113883.6.1']"><axsl:attribute name="id">a-18414</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This code SHALL
        contain exactly one [1..1] @code="REPR-X" Reporting Rate (for Proportion Measures)
        (CodeSystem: LOINC 2.16.840.1.113883.6.1 STATIC) (CONF:18414).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="not(cda:referenceRange) or cda:referenceRange[count(cda:observationRange)=1]"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="not(cda:referenceRange) or cda:referenceRange[count(cda:observationRange)=1]"><axsl:attribute name="id">a-18417</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>The
        referenceRange, if present, SHALL contain exactly one [1..1] observationRange
        (CONF:18417).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>
...
<axsl:choose><axsl:when test="cda:statusCode[@code='completed']"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="cda:statusCode[@code='completed']"><axsl:attribute name="id">a-18420</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>This statusCode SHALL
        contain exactly one [1..1] @code="completed" completed (CodeSystem: ActStatus
        2.16.840.1.113883.5.14 STATIC) (CONF:18420).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M26"/></axsl:template><axsl:template match="text()" priority="-1" mode="M26"/><axsl:template match="@*|node()" priority="-2" mode="M26"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M26"/></axsl:template>

<!--PATTERN p-2.16.840.1.113883.10.20.22.5.2-errors-->


	<!--RULE r-2.16.840.1.113883.10.20.22.5.2-errors-->
<axsl:template match="cda:AD[cda:templateId/@root='2.16.840.1.113883.10.20.22.5.2']" priority="1000" mode="M27"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:AD[cda:templateId/@root='2.16.840.1.113883.10.20.22.5.2']" id="r-2.16.840.1.113883.10.20.22.5.2-errors"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:streetAddressLine[@xsi:type='ST']) &gt; 0 and count(cda:streetAddressLine[@xsi:type='ST']) &lt; 5"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:streetAddressLine[@xsi:type='ST']) &gt; 0 and count(cda:streetAddressLine[@xsi:type='ST']) &lt; 5"><axsl:attribute name="id">a-7291</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain at least one and not more than 4 streetAddressLine (CONF:7291).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:city[@xsi:type='ST'])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:city[@xsi:type='ST'])=1"><axsl:attribute name="id">a-7292</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one
        [1..1] city (CONF:7292).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M27"/></axsl:template><axsl:template match="text()" priority="-1" mode="M27"/><axsl:template match="@*|node()" priority="-2" mode="M27"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M27"/></axsl:template>

<!--PATTERN p-2.16.840.1.113883.10.20.22.5.1.1-errors-->


	<!--RULE r-2.16.840.1.113883.10.20.22.5.1.1-errors-->
<axsl:template match="cda:PN[cda:templateId/@root='2.16.840.1.113883.10.20.22.5.1.1']" priority="1000" mode="M28"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:PN[cda:templateId/@root='2.16.840.1.113883.10.20.22.5.1.1']" id="r-2.16.840.1.113883.10.20.22.5.1.1-errors"/>

		<!--ASSERT -->
<axsl:choose><axsl:when test="count(cda:name)=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:name)=1"><axsl:attribute name="id">a-9368</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly one [1..1] name
        (CONF:9368).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M28"/></axsl:template><axsl:template match="text()" priority="-1" mode="M28"/><axsl:template match="@*|node()" priority="-2" mode="M28"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M28"/></axsl:template>

<!--PATTERN p-2.16.840.1.113883.10.20.17.3.8-errors-->


	<!--RULE r-2.16.840.1.113883.10.20.17.3.8-errors-->
<axsl:template match="cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.17.3.8']" priority="1000" mode="M29"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.17.3.8']" id="r-2.16.840.1.113883.10.20.17.3.8-errors"/>
...
<axsl:choose><axsl:when test="count(cda:templateId[@root='2.16.840.1.113883.10.20.17.3.8'])=1"/><axsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:schold="http://www.ascc.net/xml/schematron" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.17.3.8'])=1"><axsl:attribute name="id">a-18099</axsl:attribute><axsl:attribute name="location"><axsl:apply-templates select="." mode="schematron-get-full-path"/></axsl:attribute><svrl:text>SHALL contain exactly
        ...
        @root="2.16.840.1.113883.10.20.17.3.8" (CONF:18099).</svrl:text></svrl:failed-assert></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M29"/></axsl:template><axsl:template match="text()" priority="-1" mode="M29"/><axsl:template match="@*|node()" priority="-2" mode="M29"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M29"/></axsl:template></axsl:stylesheet>
