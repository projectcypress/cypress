...
gem 'cqm-reports', git: 'https://github.com/projecttacoma/cqm-reports.git', branch: 'export_multi_obs'
gem 'cqm-validators', git: 'https://github.com/projecttacoma/cqm-validators.git', branch: 'export_multi_obs'
