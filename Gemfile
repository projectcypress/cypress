...
gem 'cqm-reports', git: 'https://github.com/projecttacoma/cqm-reports', branch: 'full_html_rendering'
# gem 'cqm-reports', git: 'https://github.com/projecttacoma/cqm-reports', branch: 'use_schematron'
